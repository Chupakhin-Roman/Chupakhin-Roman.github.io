...
for (n = 0; n < v.length; n++) {
    ...
    i.setAttribute("src", "https_40i.ytimg.com/vi/" + y.id + "/hqdefault.jpg");
    ...
    y.onclick = function() {
        ...
        a.setAttribute("src", "https_40www.youtube.com/embed/" + this.id + "_40autoplay=1&autohide=1&border=0&wmode=opaque&enablejsapi=1&rel=0&showinfo=0");
